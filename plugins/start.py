...
async def start(client,message):
	...
	reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(' ⚚     ɱᴀɪɴ   ᴄʜᴀɴɴᴇʟ     ⚚ ', url='https://youtube.com/@NobiDeveloper')],[InlineKeyboardButton(' 👨‍💻   ᴏᴡɴᴇʀ ', url='https://telegram.me/NobiDeveloper'),InlineKeyboardButton(' 📝   ᴀʙᴏᴜᴛ ', callback_data = "upgrade")]]))
	    return
	if id:
	    if old == True:
	        try:
